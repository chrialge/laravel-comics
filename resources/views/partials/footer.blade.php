                    ...
                    <div class="row row-cols-3">
                        ...
                        <div class="col">
                            ...
                            <ul class=" list-unstyled">
                                ...
                                <li><a href="#" class=" text-decoration-none text_footer">Character</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">Comics</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">Movies</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">TV</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">Games</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">Videos</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">News</a></li>
                            </ul>
                        ...
                        <div class="col">
                            <ul class=" list-unstyled">
                                ...
                                <li><a href="#" class=" text-decoration-none text_footer">DC</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">MAD Magazine</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">DC Kids</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">DC Universe</a></li>
                                <li><a href="#" class=" text-decoration-none text_footer">DC Power Visa</a></li>
                            </ul>
                        </div>
